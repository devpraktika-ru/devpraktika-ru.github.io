...
<div class="row g-4">
  <div class="col-12 col-lg-8">
    ...
    <p>
      ...
      Мы — практикум для мидлов и сеньоров: учимся делать, подсматривая у более опытных коллег.
      Без сертификатов, домашних заданий и отметок посещаемости.
    </p>
    <p>
      Архитектурные воркшопы, код-ретриты с парным программированием и TDD, подготовка технических докладов — всё в выходные, чтобы работа не мешала учёбе.
      Ведут практикующие программисты с многолетним опытом в индустрии.
    </p>
  </div>
